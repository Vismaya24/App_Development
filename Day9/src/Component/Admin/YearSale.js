...
const YearSale = () =>{
    ...
    return(
        <>
     <div className="line"style={{ maxWidth: "1700px", marginLeft: "200px"  }} >
     <CanvasJSChart options = {yearlySale} />
     </div>
    <div style={{textAlign: "center", fontSize: "20px", fontFamily: "Catamaran"}}>Total ArtWorks Sold - Year 2022<br></br>{data.totalProducts}</div>
     </>
    )
}
